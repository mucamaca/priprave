...
%#insert python3 style.py < snippets/more-conditionals/nizanje-narobe.cpp

V takem primeru nam je na voljo bližnjica \verb+else if+. Zgornja koda deluje
popolnoma enako kot spodnja:

%#insert python3 style.py < snippets/more-conditionals/nizanje-pravilno.cpp
...
%#insert python3 style.py < snippets/more-conditionals/vecje-manjse-enako.cpp
...
%#insert python3 style.py < snippets/more-conditionals/nizanje-elseif.cpp
...
%#insert python3 style.py < snippets/more-conditionals/med-steviloma.cpp
...
%#insert python3 style.py < snippets/more-conditionals/prestopno-leto.cpp
