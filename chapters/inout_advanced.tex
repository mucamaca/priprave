...
%#insert python3 style.py < snippets/inout_advanced/formatnik_s.cpp
...
%#insert python3 style.py < snippets/inout_advanced/do_konca_vrstice.cpp
...
%#insert python3 style.py < snippets/inout_advanced/do_konca_vhoda.cpp
...
%#insert python3 style.py < snippets/inout_advanced/stevilo_prebranih.cpp
...
%#insert python3 style.py < snippets/inout_advanced/sprintf.cpp
...
%#insert python3 style.py < snippets/inout_advanced/datoteke.cpp
