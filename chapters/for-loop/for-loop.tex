...
%#insert python3 style.py < snippets/for-loop/sintaksa.cpp
...
%#insert python3 style.py < snippets/for-loop/puscica.cpp
...
%#insert python3 style.py < snippets/for-loop/branje-stevil.cpp
...
%#insert python3 style.py < snippets/for-loop/branje-z-while.cpp
...
%#insert python3 style.py < snippets/for-loop/napaka.cpp
...
%#insert python3 style.py < snippets/for-loop/soda-stevila.cpp
