...
Pogoje združujemo s t.i. \emph{logični operatorji}. Poznamo tri osnovne take
operatorje:
\begin{itemize}
...
Pri kombiniranju pogojev bodimo previdni glede pravil prednosti. Negacija
(operator \verb+not+ oz.~\verb+!+) ima namreč prednost pred veliko večino
drugih operatorjev - to vključuje matematične operatorje
(\verb|+, -, *, /, \%|), primerjalne operatorje (\verb|==, <, ...|) in tudi
ostala logična operatorja. Če v takem primeru uporabljamo negacijo, moramo
negiran izraz postaviti v oklepaje.

\begin{examples}
  Negiranje se lahko v večini primerov zapiše tudi na krajši način.
...
Kako te pogoje zapišemo v program? Opazimo, da so leta, deljiva s 400, prestopna ne glede na druga
pogoja. Če leto ni deljivo s 400, potem mora biti hkrati deljivo s 4, ampak ne deljivo s 100.
Povedano na krajše; leto mora biti deljivo s 400, ali pa s 4 in ne hkrati s 100. Tak pogoj lahko
zapišemo z logičnimi operatorji.
